...
class Robot:
    def __init__(self, x=0, y=0, theta=0, v=0, w=0, dt=0.1):
        # Initialize the robot's position and orientation,x and y are coordinates and theta is the angle in radians; v is linear velocity and w is angular velocity; dt is time step
        self.x = x
        self.y = y
        self.theta = theta
        self.v = v
